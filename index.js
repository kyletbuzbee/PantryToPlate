...
const max = require('math-intrinsics/max');
...
var ThrowTypeError = $gOPD
    ? (function () {
        try {
            ...
            (function callee() {}).name; // IE 8 does not throw here
...
if (getProto) {
    try {
        // intentional error to capture prototype
        throw new Error(); // eslint-disable-line no-unused-expressions
    } catch (e) {
        // https://github.com/tc39/proposal-shadowrealm/pull/384#issuecomment-1364264229
        var errorProto = getProto(e);
